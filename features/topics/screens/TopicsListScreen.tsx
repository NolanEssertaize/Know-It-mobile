 ...
 * @description Écran principal - Liste des sujets - Theme Aware + i18n
 *
 * MERGED:
            ...
            <View style={styles.listHeader}>
                ...
                <View style={styles.sectionHeader}>
                    <Text style={[styles.sectionTitle, { color: colors.text.secondary }]}>
                        {t('topics.myTopics', 'Mes Sujets')}
                    </Text>
                    <Text style={[styles.sectionCount, { color: colors.text.muted }]}>
                        {t('topics.topicsCount', { count: logic.filteredTopics.length, defaultValue: '{{count}} sujets' })}
                    </Text>
                </View>
                ...
                <View style={styles.swipeHintContainer}>
                    ...
                    <Text style={[styles.swipeHint, { color: colors.text.muted }]}>
                        {t('topics.swipeHint', 'Glissez pour plus d\'options')}
                    </Text>
                </View>
                ...
                {logic.hasActiveFilters && (
                    ...
                    >
                        <Text style={[styles.activeFiltersText, { color: colors.text.primary }]}>
                            {t('topics.activeFilters', 'Filtres actifs')}
                        </Text>
        ...
        () => (
            <View style={styles.emptyContainer}>
                ...
                <Text style={[styles.emptyTitle, { color: colors.text.primary }]}>
                    {t('topics.empty.title', 'Aucun sujet trouvé')}
                </Text>
                <Text style={[styles.emptyDescription, { color: colors.text.secondary }]}>
                    {logic.hasActiveFilters
                        ? t('topics.empty.descriptionWithFilters', 'Essayez de modifier vos filtres')
                        : t('topics.empty.description', 'Créez votre premier sujet pour commencer')}
                </Text>
                {!logic.hasActiveFilters && (
                    <Pressable
                    ...
                    >
                        ...
                        <Text style={[styles.emptyButtonText, { color: colors.text.inverse }]}>
                            {t('topics.empty.createButton', 'Créer un sujet')}
                        </Text>
                    </Pressable>
                )}
            </View>
            ...
            <View style={styles.header}>
                <View>
                    <Text style={[styles.title, { color: colors.text.primary }]}>
                        {t('topics.title', 'Prêt à apprendre ?')}
                    </Text>
                </View>
                <ProfileButton />
            </View>
            ...
            <View style={styles.statsContainer}>
                <View style={styles.statsRow}>
                    ...
                    <GlassView style={[styles.statCard, { borderColor: colors.glass.border }]}>
                        ...
                        <Text style={[styles.statLabel, { color: colors.text.muted }]}>
                            {t('topics.stats.sessions', 'Sessions')}
                        </Text>
                    </GlassView>
                ...
                <GlassView style={styles.searchContainer}>
                    ...
                    <TextInput
                        ...
                        placeholder={t('topics.search.placeholder', 'Rechercher un sujet...')}
